...
namespace WinApp.Core.Utility.SQLite
{
    public enum ColType
    {
        Text,
    ...
    public class SQLiteHelper
    {
        ...
        public SQLiteHelper(string dbPath)
        {
            ...
            try
            {
                cmd.Connection = new SQLiteConnection(this.ConnectionString);
            }
            catch (Exception ex)
            {
                string s = ex.Message;
        ...
        public static string GetDBName { get { return "data.db"; } }
        //public static string GetMainAppName {
        //    get
        //    {
        //        string[] paths = Application.ExecutablePath.Split(new string[] { "\\" }, StringSplitOptions.None);
        //        return paths[paths.Length - 1].Replace(".EXE", "").Replace(".exe","");
        //    }
        //}
        public static string GetPath()
        {
            return Path.GetDirectoryName(Assembly.GetEntryAssembly().Location) + "\\Data\\" + GetDBName;
        }
        ...
        public SQLiteHelper()
        {
            ...
            this.ConnectionString = "Data Source=" + GetPath();
        ...
        public DataTable SqlLite_GetDataTable(string CommandText)
        {
        ...
        public bool SqlLite_ExecuteNonQuery(string CommandText, List<SQLiteParameter> parameters)
        {
            DataTable dtRes = new DataTable();
        ...
        public bool SqlLite_ExecuteInsert(string TableName, Dictionary<string, object> dic)
        {
            StringBuilder sbCol = new System.Text.StringBuilder();
            StringBuilder sbVal = new System.Text.StringBuilder();
        ...
        public byte[] StrToByteArray(string strValue)
        {
